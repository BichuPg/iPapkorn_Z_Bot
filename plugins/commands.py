...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🤖 𝚄𝚙𝚍𝚊𝚝𝚎𝚜 🤖', url='https://t.me/TechnicalBichu')
            ],
            [
                InlineKeyboardButton('ℹ️ 𝙷𝚎𝚕𝚙 ℹ️', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🎗 𝙶𝚛𝚘𝚞𝚙 🎗', url='https://t.me/TechnicalBichu'),
            InlineKeyboardButton('🤖 𝚄𝚙𝚍𝚊𝚝𝚎𝚜 🤖', url='https://t.me/TechnicalBichu')
            ],[
            InlineKeyboardButton('ℹ️ 𝙷𝚎𝚕𝚙 ℹ️', callback_data='help'),
